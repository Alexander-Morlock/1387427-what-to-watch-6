      ...
      <section className="catalog">
        ...
        <div className="catalog__movies-list">
          ...
          <article className="small-movie-card catalog__movies-card">
            ...
            <h3 className="small-movie-card__title">
              <Link className="small-movie-card__link" to="movie-page.html">We need to talk about Kevin</Link>
            </h3>
          </article>
          <article className="small-movie-card catalog__movies-card">
            <div className="small-movie-card__image">
            ...
            <h3 className="small-movie-card__title">
              <Link className="small-movie-card__link" to="movie-page.html">What We Do in the Shadows</Link>
            </h3>
          </article>
          <article className="small-movie-card catalog__movies-card">
            <div className="small-movie-card__image">
            ...
            <h3 className="small-movie-card__title">
              <Link className="small-movie-card__link" to="movie-page.html">Revenant</Link>
            </h3>
          </article>
          <article className="small-movie-card catalog__movies-card">
            <div className="small-movie-card__image">
            ...
            <h3 className="small-movie-card__title">
              <Link className="small-movie-card__link" to="movie-page.html">Johnny English</Link>
            </h3>
          </article>
          <article className="small-movie-card catalog__movies-card">
            <div className="small-movie-card__image">
            ...
            <h3 className="small-movie-card__title">
              <Link className="small-movie-card__link" to="movie-page.html">Shutter Island</Link>
            </h3>
          </article>
        </div>
      </section>
